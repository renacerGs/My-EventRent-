  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pb-20 font-sans relative">
      ...
      <div className="relative w-full h-[280px] md:h-[500px] bg-gray-900">
        ...
        <button onClick={() => navigate('/')} className="absolute top-4 left-4 md:top-8 md:left-8 w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-white/20 backdrop-blur-md rounded-full text-white hover:bg-white hover:text-gray-900 transition-all z-20">
